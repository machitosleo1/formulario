...
//Success message
define('__SUCCESS_MESSAGE__', "Tu mensaje ha sido enviado. Responderemos pronto. ¡Gracias!");

//Error message 
define('__ERROR_MESSAGE__', "Tu mensaje no ha sido enviado. Inténtalo de nuevo.");
...
if(isset($_POST['name']) and isset($_POST['mail']) and isset($_POST['messageForm'])){
    ...
    if($name == '') {
        echo json_encode(array('info' => 'error', 'msg' => "Por favor ingrese su nombre"));
        exit();
    } else if($mail == '' or check_email($mail) == false){
        echo json_encode(array('info' => 'error', 'msg' => "Por favor introduzca su correo electrónico"));
        exit();
    } else if($messageForm == ''){
